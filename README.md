...
- OpenText Documentum (20.x, 22.x), Alfresco
- Content migration (DFC, DQL)
- MS SQL Server, Azure IaaS / Managed Instance
- PowerShell, Java
- CI/CD, ITIL, Incident & Problem Management
- Input Accel, D2 applications
- ServiceNow, TeamCity, New Relic
...
- MBA — ICFAI (Distance Learning)
- BSc Electronics & Computer Maintenance — Union Christian College
...
- `index.html` - Main professional profile page
- `README.md` - This file

## 🌐 View My Profile

Visit the live profile: [abhysunny.github.io](https://abhysunny.github.io)
